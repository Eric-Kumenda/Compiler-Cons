...
```mermaid
graph TD
    main["main()"] --> NewParser["NewParser(tokens)"]
    main --> parseProgram["parseProgram()"]

    parseProgram --> parseStmtList["parseStmtList()"]

    parseStmtList --> parseStmt["parseStmt()"]
    parseStmtList -->|recursion| parseStmtList

    parseStmt --> parseDeclStmt["parseDeclStmt()"]
    parseStmt --> parseAssignStmt["parseAssignStmt()"]
    parseStmt --> parseIfStmt["parseIfStmt()"]
    parseStmt --> parseWhileStmt["parseWhileStmt()"]
    parseStmt --> parseReturnStmt["parseReturnStmt()"]

    parseIfStmt --> parseCondExpr["parseCondExpr()"]
    parseIfStmt --> parseStmtList
    parseIfStmt --> parseElsePart["parseElsePart()"]
    ...
    %% Helpers used by all
    parseDeclStmt --> expect["expect() / expectKeyword() / expectPunctuation()"]
    ...
    style parseProgram fill:#2d8cf0,stroke:#333,color:#fff
    style parseStmtList fill:#19be6b,stroke:#333,color:#fff
    style parseStmt fill:#19be6b,stroke:#333,color:#fff
    style parseDeclStmt fill:#ff9900,stroke:#333,color:#fff
    style parseAssignStmt fill:#ff9900,stroke:#333,color:#fff
    style parseIfStmt fill:#ff9900,stroke:#333,color:#fff
    style parseElsePart fill:#ff9900,stroke:#333,color:#fff
    style parseWhileStmt fill:#ff9900,stroke:#333,color:#fff
    style parseReturnStmt fill:#ff9900,stroke:#333,color:#fff
    style parseExpr fill:#ed4014,stroke:#333,color:#fff
    style parseExprTail fill:#ed4014,stroke:#333,color:#fff
    style parseTerm fill:#ed4014,stroke:#333,color:#fff
    style parseTermTail fill:#ed4014,stroke:#333,color:#fff
    style parseFactor fill:#ed4014,stroke:#333,color:#fff
    style parseCondExpr fill:#ed4014,stroke:#333,color:#fff
    style parseRelOp fill:#ed4014,stroke:#333,color:#fff
    style expect fill:#515a6e,stroke:#333,color:#fff
    style peek fill:#515a6e,stroke:#333,color:#fff
    style advance fill:#515a6e,stroke:#333,color:#fff
```
